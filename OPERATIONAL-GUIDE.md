...
This document is the **master technical guide and operational runbook** for the lab. It is split into two parts:
...
The scenarios under [`core-vms/`](core-vms) and [`advanced-vms/`](advanced-vms) are the **lab-verified reproductions** of every situation discussed below.
