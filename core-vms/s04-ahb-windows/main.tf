...
resource "azurerm_resource_group" "this" {
  name     = "rg-vm-retirement-core-s04"
...
resource "azurerm_windows_virtual_machine" "this" {
  name                  = "vm-core-ahb-win-01"
  computer_name         = "ahbwin01"
  location              = azurerm_resource_group.this.location
  resource_group_name   = azurerm_resource_group.this.name
  size                  = "Standard_B2ms"
  ...
  license_type          = var.enable_ahb_on_windows_lab_vm ? "Windows_Server" : null
  tags                  = local.common_tags
...
output "license_type" { value = azurerm_windows_virtual_machine.this.license_type }
